...
| [RFC-0003](./RFC-0003-verification.md) | Verification — three tiers, random sampling, human feedback aggregation | Draft v0.1 (early) | RFC-0001, RFC-0002, RFC-0005 |
| [RFC-0004](./RFC-0004-reputation-pouh.md) | Reputation Chain with Proof-of-Unique-Hardware Consensus | Draft v0.1 (early) | RFC-0003, RFC-0005 |
