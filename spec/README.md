...
| [RFC-0009](./RFC-0009-canonical-numerics.md) | Canonical Numerics for Verifiable Inference — INT8-GPTQ default + FP16 fallback; Y_canon unifies serving/caching; q24 collision bounds; bit-exact per-token scale; C library leveraging ggml | Draft v0.5 (early) | RFC-0002, RFC-0003, RFC-0008 |
